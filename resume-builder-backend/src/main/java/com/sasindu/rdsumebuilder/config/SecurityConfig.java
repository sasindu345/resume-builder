...
public class SecurityConfig {
    ...
    /**
     * High precedence CORS filter to ensure CORS headers apply even to error responses 
     * thrown by GlobalExceptionHandler before Spring Security can fully process them.
     */
    @Bean
